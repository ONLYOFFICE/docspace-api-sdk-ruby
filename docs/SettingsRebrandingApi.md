...
> <Array(<AdditionalWhiteLabelSettingsWrapper>, Integer, Hash)> delete_additional_white_label_settings_with_http_info
...
begin
  ...
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <AdditionalWhiteLabelSettingsWrapper>
rescue DocspaceApiSdk::ApiError => e
...
> <Array(<CompanyWhiteLabelSettingsWrapper>, Integer, Hash)> delete_company_white_label_settings_with_http_info
...
begin
  ...
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <CompanyWhiteLabelSettingsWrapper>
rescue DocspaceApiSdk::ApiError => e
...
> <Array(<AdditionalWhiteLabelSettingsWrapper>, Integer, Hash)> get_additional_white_label_settings_with_http_info
...
> <Array(<CompanyWhiteLabelSettingsWrapper>, Integer, Hash)> get_company_white_label_settings_with_http_info
