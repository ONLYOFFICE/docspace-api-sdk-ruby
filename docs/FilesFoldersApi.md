...
api_instance = DocspaceApiSdk::Files::FoldersApi.new
folder_id = 1 # Integer | The folder ID whose history is exported.
opts = {
  format: DocspaceApiSdk::AuditReportFormat::Xlsx, # AuditReportFormat | The output file format of the report. Defaults to XLSX.
  from: Time.parse('2025-01-01T00:00:00'), # Time | The start date of the history period to export.
  to: Time.parse('2025-12-31T23:59:59') # Time | The end date of the history period to export.
}
...
| Name | Type | Description | Notes |
| ---- | ---- | ----------- | ----- |
| **folder_id** | **Integer** | The folder ID whose history is exported. |  |
| **format** | **AuditReportFormat** | The output file format of the report. Defaults to XLSX. | [optional] |
| **from** | **Time** | The start date of the history period to export. | [optional] |
| **to** | **Time** | The end date of the history period to export. | [optional] |
...
opts = {
  ...
  folder_type: [0], # Array<Integer> | The parent folder types used to filter the folder contents by folder type.
...
| **folder_type** | [**Array&lt;Integer&gt;**](Integer.md) | The parent folder types used to filter the folder contents by folder type. | [optional] |
...
opts = {
  from_date: Time.parse('2025-01-01T00:00:00.0000000Z'), # Time | The start date of the history request.
  to_date: Time.parse('2025-12-31T23:59:59.0000000Z'), # Time | The end date of the history request.
...
| **from_date** | **Time** | The start date of the history request. | [optional] |
| **to_date** | **Time** | The end date of the history request. | [optional] |
...
> <FolderContentIntegerWrapper> get_forms_folder(opts)
...
> <Array(<FolderContentIntegerWrapper>, Integer, Hash)> get_forms_folder_with_http_info(opts)
...
opts = {
  ...
  apply_filter_option: DocspaceApiSdk::ApplyFilterOption::All, # ApplyFilterOption | Specifies whether to return only files, only folders or all elements.
  search_area: DocspaceApiSdk::SearchArea::Active, # SearchArea | The search area.
  extension: ['inner_example'], # Array<String> | Specifies whether to search for a specific file extension in the Recent folder.
...
api_instance = DocspaceApiSdk::Files::FoldersApi.new
folder_id = 56 # Integer | The folder unique identifier.
