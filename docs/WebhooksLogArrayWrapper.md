# DocspaceApiSdk::WebhooksLogArrayWrapper

## Properties

| Name | Type | Description | Notes |
| ---- | ---- | ----------- | ----- |
| **response** | [**Array&lt;WebhooksLogDto&gt;**](WebhooksLogDto.md) | The list of WebhooksLogDto objects returned by the operation. | [optional] |
...
instance = DocspaceApiSdk::WebhooksLogArrayWrapper.new(
  response: null,
  count: null,
  links: null,
  status: null,
