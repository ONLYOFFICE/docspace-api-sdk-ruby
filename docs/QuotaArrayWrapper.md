# DocspaceApiSdk::QuotaArrayWrapper

## Properties

| Name | Type | Description | Notes |
| ---- | ---- | ----------- | ----- |
| **response** | [**Array&lt;QuotaDto&gt;**](QuotaDto.md) | The list of QuotaDto objects returned by the operation. | [optional] |
...
instance = DocspaceApiSdk::QuotaArrayWrapper.new(
  response: null,
  count: null,
  links: null,
  status: null,
