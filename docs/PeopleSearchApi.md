...
opts = {
  ...
  employee_types: [[1, 2]], # Array<EmployeeType> | The list of the user types.
...
opts = {
  ...
  employee_types: [[1, 2]], # Array<Integer> | The list of user types.
...
opts = {
  ...
  employee_types: [[1, 2]], # Array<EmployeeType> | The list of user types.
