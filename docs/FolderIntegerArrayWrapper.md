# DocspaceApiSdk::FolderIntegerArrayWrapper

## Properties

| Name | Type | Description | Notes |
| ---- | ---- | ----------- | ----- |
| **response** | [**Array&lt;FolderDtoInteger&gt;**](FolderDtoInteger.md) | The list of FolderDtoInteger objects returned by the operation. | [optional] |
...
instance = DocspaceApiSdk::FolderIntegerArrayWrapper.new(
  response: null,
  count: null,
  links: null,
  status: null,
