# DocspaceApiSdk::CompanyWhiteLabelSettingsArrayWrapper

## Properties

| Name | Type | Description | Notes |
| ---- | ---- | ----------- | ----- |
| **response** | [**Array&lt;CompanyWhiteLabelSettings&gt;**](CompanyWhiteLabelSettings.md) | The list of CompanyWhiteLabelSettings objects returned by the operation. | [optional] |
...
instance = DocspaceApiSdk::CompanyWhiteLabelSettingsArrayWrapper.new(
  response: null,
  count: null,
  links: null,
  status: null,
