# DocspaceApiSdk::TimezonesRequestsArrayWrapper

## Properties

| Name | Type | Description | Notes |
| ---- | ---- | ----------- | ----- |
| **response** | [**Array&lt;TimezonesRequestsDto&gt;**](TimezonesRequestsDto.md) | The list of TimezonesRequestsDto objects returned by the operation. | [optional] |
...
instance = DocspaceApiSdk::TimezonesRequestsArrayWrapper.new(
  response: null,
  count: null,
  links: null,
  status: null,
