# DocspaceApiSdk::GroupMemberSecurityRequestArrayWrapper

## Properties

| Name | Type | Description | Notes |
| ---- | ---- | ----------- | ----- |
| **response** | [**Array&lt;GroupMemberSecurityRequestDto&gt;**](GroupMemberSecurityRequestDto.md) | The list of GroupMemberSecurityRequestDto objects returned by the operation. | [optional] |
...
instance = DocspaceApiSdk::GroupMemberSecurityRequestArrayWrapper.new(
  response: null,
  count: null,
  links: null,
  status: null,
