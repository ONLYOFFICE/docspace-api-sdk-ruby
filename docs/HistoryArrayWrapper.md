# DocspaceApiSdk::HistoryArrayWrapper

## Properties

| Name | Type | Description | Notes |
| ---- | ---- | ----------- | ----- |
| **response** | [**Array&lt;HistoryDto&gt;**](HistoryDto.md) | The list of HistoryDto objects returned by the operation. | [optional] |
...
instance = DocspaceApiSdk::HistoryArrayWrapper.new(
  response: null,
  count: null,
  links: null,
  status: null,
