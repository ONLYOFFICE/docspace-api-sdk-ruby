# DocspaceApiSdk::GetPortalPrices200Response

## Properties

| Name | Type | Description | Notes |
| ---- | ---- | ----------- | ----- |
| **response** | **Hash&lt;String, Float&gt;** | The response payload. | [optional] |
...
instance = DocspaceApiSdk::GetPortalPrices200Response.new(
  response: null,
  count: null,
  links: null,
  status: null,
