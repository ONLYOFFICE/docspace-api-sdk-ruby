# DocspaceApiSdk::StorageArrayWrapper

## Properties

| Name | Type | Description | Notes |
| ---- | ---- | ----------- | ----- |
| **response** | [**Array&lt;StorageDto&gt;**](StorageDto.md) | The list of StorageDto objects returned by the operation. | [optional] |
...
instance = DocspaceApiSdk::StorageArrayWrapper.new(
  response: null,
  count: null,
  links: null,
  status: null,
