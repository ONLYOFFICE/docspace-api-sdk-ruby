# DocspaceApiSdk::FormsItemArrayWrapper

## Properties

| Name | Type | Description | Notes |
| ---- | ---- | ----------- | ----- |
| **response** | [**Array&lt;FormsItemDto&gt;**](FormsItemDto.md) | The list of FormsItemDto objects returned by the operation. | [optional] |
...
instance = DocspaceApiSdk::FormsItemArrayWrapper.new(
  response: null,
  count: null,
  links: null,
  status: null,
