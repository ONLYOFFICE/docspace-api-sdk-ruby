# DocspaceApiSdk::AccountInfoArrayWrapper

## Properties

| Name | Type | Description | Notes |
| ---- | ---- | ----------- | ----- |
| **response** | [**Array&lt;AccountInfoDto&gt;**](AccountInfoDto.md) | The list of AccountInfoDto objects returned by the operation. | [optional] |
...
instance = DocspaceApiSdk::AccountInfoArrayWrapper.new(
  response: null,
  count: null,
  links: null,
  status: null,
