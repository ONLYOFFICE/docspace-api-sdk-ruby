# DocspaceApiSdk::WhiteLabelItemArrayWrapper

## Properties

| Name | Type | Description | Notes |
| ---- | ---- | ----------- | ----- |
| **response** | [**Array&lt;WhiteLabelItemDto&gt;**](WhiteLabelItemDto.md) | The list of WhiteLabelItemDto objects returned by the operation. | [optional] |
...
instance = DocspaceApiSdk::WhiteLabelItemArrayWrapper.new(
  response: null,
  count: null,
  links: null,
  status: null,
