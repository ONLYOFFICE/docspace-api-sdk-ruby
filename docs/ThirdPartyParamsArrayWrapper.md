# DocspaceApiSdk::ThirdPartyParamsArrayWrapper

## Properties

| Name | Type | Description | Notes |
| ---- | ---- | ----------- | ----- |
| **response** | [**Array&lt;ThirdPartyParams&gt;**](ThirdPartyParams.md) | The list of ThirdPartyParams objects returned by the operation. | [optional] |
...
instance = DocspaceApiSdk::ThirdPartyParamsArrayWrapper.new(
  response: null,
  count: null,
  links: null,
  status: null,
