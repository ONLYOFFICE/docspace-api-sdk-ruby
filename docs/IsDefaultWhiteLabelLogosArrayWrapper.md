# DocspaceApiSdk::IsDefaultWhiteLabelLogosArrayWrapper

## Properties

| Name | Type | Description | Notes |
| ---- | ---- | ----------- | ----- |
| **response** | [**Array&lt;IsDefaultWhiteLabelLogosDto&gt;**](IsDefaultWhiteLabelLogosDto.md) | The list of IsDefaultWhiteLabelLogosDto objects returned by the operation. | [optional] |
...
instance = DocspaceApiSdk::IsDefaultWhiteLabelLogosArrayWrapper.new(
  response: null,
  count: null,
  links: null,
  status: null,
