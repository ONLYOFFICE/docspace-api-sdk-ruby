# DocspaceApiSdk::FileIntegerArrayWrapper

## Properties

| Name | Type | Description | Notes |
| ---- | ---- | ----------- | ----- |
| **response** | [**Array&lt;FileDtoInteger&gt;**](FileDtoInteger.md) | The list of FileDtoInteger objects returned by the operation. | [optional] |
...
instance = DocspaceApiSdk::FileIntegerArrayWrapper.new(
  response: null,
  count: null,
  links: null,
  status: null,
