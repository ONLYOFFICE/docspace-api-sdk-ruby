# DocspaceApiSdk::UsageSpaceStatItemArrayWrapper

## Properties

| Name | Type | Description | Notes |
| ---- | ---- | ----------- | ----- |
| **response** | [**Array&lt;UsageSpaceStatItemDto&gt;**](UsageSpaceStatItemDto.md) | The list of UsageSpaceStatItemDto objects returned by the operation. | [optional] |
...
instance = DocspaceApiSdk::UsageSpaceStatItemArrayWrapper.new(
  response: null,
  count: null,
  links: null,
  status: null,
