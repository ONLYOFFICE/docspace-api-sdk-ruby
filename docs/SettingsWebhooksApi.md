...
api_instance = DocspaceApiSdk::Settings::WebhooksApi.new
opts = {
  delivery_from: Time.parse('2024-01-15T10:30:00Z'), # Time | The delivery start time for filtering webhook logs.
  delivery_to: Time.parse('2024-01-15T10:30:00Z'), # Time | The delivery end time for filtering webhook logs.
  ...
  user_id: '{}', # String | The identifier of the user associated with the webhook event.
