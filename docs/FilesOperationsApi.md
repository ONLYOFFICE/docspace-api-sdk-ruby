...
opts = {
  ...
  folder_type: [0] # Array<Integer> | The parent folder types used to empty the trash only from the items originally located in the sections of the specified types.
}
...
| **folder_type** | [**Array&lt;Integer&gt;**](Integer.md) | The parent folder types used to empty the trash only from the items originally located in the sections of the specified types. | [optional] |
