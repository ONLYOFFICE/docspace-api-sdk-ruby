# DocspaceApiSdk::AiFolderIntegerArrayWrapper

## Properties

| Name | Type | Description | Notes |
| ---- | ---- | ----------- | ----- |
| **response** | [**Array&lt;AiFolderDtoInteger&gt;**](AiFolderDtoInteger.md) | The list of FolderDtoInteger objects returned by the operation. | [optional] |
...
instance = DocspaceApiSdk::AiFolderIntegerArrayWrapper.new(
  response: null,
  count: null,
  links: null,
  status: null,
