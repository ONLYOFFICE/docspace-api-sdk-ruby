# DocspaceApiSdk::FileEntryBaseArrayWrapper

## Properties

| Name | Type | Description | Notes |
| ---- | ---- | ----------- | ----- |
| **response** | [**Array&lt;FileEntryBaseDto&gt;**](FileEntryBaseDto.md) | The list of FileEntryBaseDto objects returned by the operation. | [optional] |
...
instance = DocspaceApiSdk::FileEntryBaseArrayWrapper.new(
  response: null,
  count: null,
  links: null,
  status: null,
