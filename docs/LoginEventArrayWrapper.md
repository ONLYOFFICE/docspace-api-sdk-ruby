# DocspaceApiSdk::LoginEventArrayWrapper

## Properties

| Name | Type | Description | Notes |
| ---- | ---- | ----------- | ----- |
| **response** | [**Array&lt;LoginEventDto&gt;**](LoginEventDto.md) | The list of LoginEventDto objects returned by the operation. | [optional] |
...
instance = DocspaceApiSdk::LoginEventArrayWrapper.new(
  response: null,
  count: null,
  links: null,
  status: null,
