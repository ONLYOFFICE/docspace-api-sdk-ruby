# DocspaceApiSdk::ProviderArrayWrapper

## Properties

| Name | Type | Description | Notes |
| ---- | ---- | ----------- | ----- |
| **response** | [**Array&lt;ProviderDto&gt;**](ProviderDto.md) | The list of ProviderDto objects returned by the operation. | [optional] |
...
instance = DocspaceApiSdk::ProviderArrayWrapper.new(
  response: null,
  count: null,
  links: null,
  status: null,
