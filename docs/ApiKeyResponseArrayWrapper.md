# DocspaceApiSdk::ApiKeyResponseArrayWrapper

## Properties

| Name | Type | Description | Notes |
| ---- | ---- | ----------- | ----- |
| **response** | [**Array&lt;ApiKeyResponseDto&gt;**](ApiKeyResponseDto.md) | The list of ApiKeyResponseDto objects returned by the operation. | [optional] |
...
instance = DocspaceApiSdk::ApiKeyResponseArrayWrapper.new(
  response: null,
  count: null,
  links: null,
  status: null,
