# DocspaceApiSdk::GroupArrayWrapper

## Properties

| Name | Type | Description | Notes |
| ---- | ---- | ----------- | ----- |
| **response** | [**Array&lt;GroupDto&gt;**](GroupDto.md) | The list of GroupDto objects returned by the operation. | [optional] |
...
instance = DocspaceApiSdk::GroupArrayWrapper.new(
  response: null,
  count: null,
  links: null,
  status: null,
