# DocspaceApiSdk::CurrenciesArrayWrapper

## Properties

| Name | Type | Description | Notes |
| ---- | ---- | ----------- | ----- |
| **response** | [**Array&lt;CurrenciesDto&gt;**](CurrenciesDto.md) | The list of CurrenciesDto objects returned by the operation. | [optional] |
...
instance = DocspaceApiSdk::CurrenciesArrayWrapper.new(
  response: null,
  count: null,
  links: null,
  status: null,
