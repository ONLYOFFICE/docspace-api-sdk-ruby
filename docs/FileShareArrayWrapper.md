# DocspaceApiSdk::FileShareArrayWrapper

## Properties

| Name | Type | Description | Notes |
| ---- | ---- | ----------- | ----- |
| **response** | [**Array&lt;FileShareDto&gt;**](FileShareDto.md) | The list of FileShareDto objects returned by the operation. | [optional] |
...
instance = DocspaceApiSdk::FileShareArrayWrapper.new(
  response: null,
  count: null,
  links: null,
  status: null,
