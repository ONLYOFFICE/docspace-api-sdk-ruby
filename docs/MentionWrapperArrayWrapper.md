# DocspaceApiSdk::MentionWrapperArrayWrapper

## Properties

| Name | Type | Description | Notes |
| ---- | ---- | ----------- | ----- |
| **response** | [**Array&lt;MentionWrapper&gt;**](MentionWrapper.md) | The list of MentionWrapper objects returned by the operation. | [optional] |
...
instance = DocspaceApiSdk::MentionWrapperArrayWrapper.new(
  response: null,
  count: null,
  links: null,
  status: null,
