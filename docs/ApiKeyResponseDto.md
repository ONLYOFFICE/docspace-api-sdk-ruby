...
| **last_used** | **Time** | The date and time when the API key was last used. | [optional] |
| **create_on** | **Time** | The date and time when the API key was created. | [optional] |
| **create_by** | [**EmployeeDto**](EmployeeDto.md) | The identifier of the user who created the API key. | [optional] |
| **expires_at** | **Time** | The date and time when the API key expires. | [optional] |
...
instance = DocspaceApiSdk::ApiKeyResponseDto.new(
  ...
  last_used: 2025-06-15T10:30:00.0000000Z,
  create_on: 2025-06-15T10:30:00.0000000Z,
  create_by: null,
  expires_at: 2025-06-15T10:30:00.0000000Z,
  is_active: true
)
```
