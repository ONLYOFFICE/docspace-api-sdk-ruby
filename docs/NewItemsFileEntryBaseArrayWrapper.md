# DocspaceApiSdk::NewItemsFileEntryBaseArrayWrapper

## Properties

| Name | Type | Description | Notes |
| ---- | ---- | ----------- | ----- |
| **response** | [**Array&lt;NewItemsDtoFileEntryBaseDto&gt;**](NewItemsDtoFileEntryBaseDto.md) | The list of NewItemsDtoFileEntryBaseDto objects returned by the operation. | [optional] |
...
instance = DocspaceApiSdk::NewItemsFileEntryBaseArrayWrapper.new(
  response: null,
  count: null,
  links: null,
  status: null,
