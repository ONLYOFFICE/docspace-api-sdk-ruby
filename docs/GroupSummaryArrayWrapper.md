# DocspaceApiSdk::GroupSummaryArrayWrapper

## Properties

| Name | Type | Description | Notes |
| ---- | ---- | ----------- | ----- |
| **response** | [**Array&lt;GroupSummaryDto&gt;**](GroupSummaryDto.md) | The list of GroupSummaryDto objects returned by the operation. | [optional] |
...
instance = DocspaceApiSdk::GroupSummaryArrayWrapper.new(
  response: null,
  count: null,
  links: null,
  status: null,
