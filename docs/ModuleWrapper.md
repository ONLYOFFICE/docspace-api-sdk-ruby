# DocspaceApiSdk::ModuleWrapper

## Properties

| Name | Type | Description | Notes |
| ---- | ---- | ----------- | ----- |
| **response** | [**ModelModule**](ModelModule.md) | The Module object returned by the operation. | [optional] |
...
instance = DocspaceApiSdk::ModuleWrapper.new(
  response: null,
  count: null,
  links: null,
  status: null,
