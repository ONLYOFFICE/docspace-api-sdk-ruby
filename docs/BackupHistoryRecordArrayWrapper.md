# DocspaceApiSdk::BackupHistoryRecordArrayWrapper

## Properties

| Name | Type | Description | Notes |
| ---- | ---- | ----------- | ----- |
| **response** | [**Array&lt;BackupHistoryRecord&gt;**](BackupHistoryRecord.md) | The list of BackupHistoryRecord objects returned by the operation. | [optional] |
...
instance = DocspaceApiSdk::BackupHistoryRecordArrayWrapper.new(
  response: null,
  count: null,
  links: null,
  status: null,
