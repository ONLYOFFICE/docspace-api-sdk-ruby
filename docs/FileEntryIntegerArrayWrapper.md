# DocspaceApiSdk::FileEntryIntegerArrayWrapper

## Properties

| Name | Type | Description | Notes |
| ---- | ---- | ----------- | ----- |
| **response** | [**Array&lt;FileEntryDtoInteger&gt;**](FileEntryDtoInteger.md) | The list of FileEntryDtoInteger objects returned by the operation. | [optional] |
...
instance = DocspaceApiSdk::FileEntryIntegerArrayWrapper.new(
  response: null,
  count: null,
  links: null,
  status: null,
