# DocspaceApiSdk::AuthServiceRequestsArrayWrapper

## Properties

| Name | Type | Description | Notes |
| ---- | ---- | ----------- | ----- |
| **response** | [**Array&lt;AuthServiceRequestsDto&gt;**](AuthServiceRequestsDto.md) | The list of AuthServiceRequestsDto objects returned by the operation. | [optional] |
...
instance = DocspaceApiSdk::AuthServiceRequestsArrayWrapper.new(
  response: null,
  count: null,
  links: null,
  status: null,
