...
> <NoContentResultWrapper> delete_recent(opts)
...
begin
  # Delete recent files
  result = api_instance.delete_recent(opts)
  p result
rescue DocspaceApiSdk::ApiError => e
...
> <Array(<NoContentResultWrapper>, Integer, Hash)> delete_recent_with_http_info(opts)
...
opts = {
  from_date: DocspaceApiSdk::ApiDateTime.new, # ApiDateTime | The start date of the history.
  to_date: DocspaceApiSdk::ApiDateTime.new, # ApiDateTime | The end date of the history.
...
> <KeyValuePairBooleanStringWrapper> track_edit_file(file_id, opts)
...
> <Array(<KeyValuePairBooleanStringWrapper>, Integer, Hash)> track_edit_file_with_http_info(file_id, opts)
...
begin
  ...
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <KeyValuePairBooleanStringWrapper>
rescue DocspaceApiSdk::ApiError => e
