# DocspaceApiSdk::NewItemsRoomNewItemsArrayWrapper

## Properties

| Name | Type | Description | Notes |
| ---- | ---- | ----------- | ----- |
| **response** | [**Array&lt;NewItemsDtoRoomNewItemsDto&gt;**](NewItemsDtoRoomNewItemsDto.md) | The list of NewItemsDtoRoomNewItemsDto objects returned by the operation. | [optional] |
...
instance = DocspaceApiSdk::NewItemsRoomNewItemsArrayWrapper.new(
  response: null,
  count: null,
  links: null,
  status: null,
