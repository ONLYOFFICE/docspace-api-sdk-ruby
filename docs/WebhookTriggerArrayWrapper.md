# DocspaceApiSdk::WebhookTriggerArrayWrapper

## Properties

| Name | Type | Description | Notes |
| ---- | ---- | ----------- | ----- |
| **response** | [**Array&lt;WebhookTriggerDto&gt;**](WebhookTriggerDto.md) | The list of WebhookTriggerDto objects returned by the operation. | [optional] |
...
instance = DocspaceApiSdk::WebhookTriggerArrayWrapper.new(
  response: null,
  count: null,
  links: null,
  status: null,
