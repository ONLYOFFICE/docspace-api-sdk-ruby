...
api_instance = DocspaceApiSdk::Rooms::RoomsApi.new
opts = {
  room_template_dto: DocspaceApiSdk::RoomTemplateDto.new({room_id: 1, title: 'My Document'}) # RoomTemplateDto | 
}
...
api_instance = DocspaceApiSdk::Rooms::RoomsApi.new
opts = {
  type: [DocspaceApiSdk::RoomType::FillingFormsRoom], # Array<RoomType> | The filter by room type.
  ...
  privacy_filter: DocspaceApiSdk::RoomPrivacyFilter::None, # RoomPrivacyFilter | The filter by room privacy (None - 0, Private - 1, NotPrivate - 2). When omitted, all rooms are returned.
...
| **privacy_filter** | **RoomPrivacyFilter** | The filter by room privacy (None - 0, Private - 1, NotPrivate - 2). When omitted, all rooms are returned. | [optional] |
...
api_instance = DocspaceApiSdk::Rooms::RoomsApi.new
id = file-id # Integer | The room ID.
