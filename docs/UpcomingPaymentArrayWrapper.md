# DocspaceApiSdk::UpcomingPaymentArrayWrapper

## Properties

| Name | Type | Description | Notes |
| ---- | ---- | ----------- | ----- |
| **response** | [**Array&lt;UpcomingPaymentDto&gt;**](UpcomingPaymentDto.md) | The list of UpcomingPaymentDto objects returned by the operation. | [optional] |
...
instance = DocspaceApiSdk::UpcomingPaymentArrayWrapper.new(
  response: null,
  count: null,
  links: null,
  status: null,
