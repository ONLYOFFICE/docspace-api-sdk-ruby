# DocspaceApiSdk::AuditEventArrayWrapper

## Properties

| Name | Type | Description | Notes |
| ---- | ---- | ----------- | ----- |
| **response** | [**Array&lt;AuditEventDto&gt;**](AuditEventDto.md) | The list of AuditEventDto objects returned by the operation. | [optional] |
...
instance = DocspaceApiSdk::AuditEventArrayWrapper.new(
  response: null,
  count: null,
  links: null,
  status: null,
