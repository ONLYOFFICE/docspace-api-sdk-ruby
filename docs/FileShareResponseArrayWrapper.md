# DocspaceApiSdk::FileShareResponseArrayWrapper

## Properties

| Name | Type | Description | Notes |
| ---- | ---- | ----------- | ----- |
| **response** | [**Array&lt;FileShare&gt;**](FileShare.md) | The list of FileShare objects returned by the operation. | [optional] |
...
instance = DocspaceApiSdk::FileShareResponseArrayWrapper.new(
  response: null,
  count: null,
  links: null,
  status: null,
