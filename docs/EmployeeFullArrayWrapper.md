# DocspaceApiSdk::EmployeeFullArrayWrapper

## Properties

| Name | Type | Description | Notes |
| ---- | ---- | ----------- | ----- |
| **response** | [**Array&lt;EmployeeFullDto&gt;**](EmployeeFullDto.md) | The list of EmployeeFullDto objects returned by the operation. | [optional] |
...
instance = DocspaceApiSdk::EmployeeFullArrayWrapper.new(
  response: null,
  count: null,
  links: null,
  status: null,
