# DocspaceApiSdk::FileOperationArrayWrapper

## Properties

| Name | Type | Description | Notes |
| ---- | ---- | ----------- | ----- |
| **response** | [**Array&lt;FileOperationDto&gt;**](FileOperationDto.md) | The list of FileOperationDto objects returned by the operation. | [optional] |
...
instance = DocspaceApiSdk::FileOperationArrayWrapper.new(
  response: null,
  count: null,
  links: null,
  status: null,
