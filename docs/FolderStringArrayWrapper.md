# DocspaceApiSdk::FolderStringArrayWrapper

## Properties

| Name | Type | Description | Notes |
| ---- | ---- | ----------- | ----- |
| **response** | [**Array&lt;FolderDtoString&gt;**](FolderDtoString.md) | The list of FolderDtoString objects returned by the operation. | [optional] |
...
instance = DocspaceApiSdk::FolderStringArrayWrapper.new(
  response: null,
  count: null,
  links: null,
  status: null,
