# DocspaceApiSdk::WebPluginArrayWrapper

## Properties

| Name | Type | Description | Notes |
| ---- | ---- | ----------- | ----- |
| **response** | [**Array&lt;WebPluginDto&gt;**](WebPluginDto.md) | The list of WebPluginDto objects returned by the operation. | [optional] |
...
instance = DocspaceApiSdk::WebPluginArrayWrapper.new(
  response: null,
  count: null,
  links: null,
  status: null,
