# DocspaceApiSdk::CustomerMonthlyUsageArrayWrapper

## Properties

| Name | Type | Description | Notes |
| ---- | ---- | ----------- | ----- |
| **response** | [**Array&lt;CustomerMonthlyUsageDto&gt;**](CustomerMonthlyUsageDto.md) | The list of CustomerMonthlyUsageDto objects returned by the operation. | [optional] |
...
instance = DocspaceApiSdk::CustomerMonthlyUsageArrayWrapper.new(
  response: null,
  count: null,
  links: null,
  status: null,
