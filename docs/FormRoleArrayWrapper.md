# DocspaceApiSdk::FormRoleArrayWrapper

## Properties

| Name | Type | Description | Notes |
| ---- | ---- | ----------- | ----- |
| **response** | [**Array&lt;FormRoleDto&gt;**](FormRoleDto.md) | The list of FormRoleDto objects returned by the operation. | [optional] |
...
instance = DocspaceApiSdk::FormRoleArrayWrapper.new(
  response: null,
  count: null,
  links: null,
  status: null,
