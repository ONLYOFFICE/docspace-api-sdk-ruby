# DocspaceApiSdk::FolderContentIntegerArrayWrapper

## Properties

| Name | Type | Description | Notes |
| ---- | ---- | ----------- | ----- |
| **response** | [**Array&lt;FolderContentDtoInteger&gt;**](FolderContentDtoInteger.md) | The list of FolderContentDtoInteger objects returned by the operation. | [optional] |
...
instance = DocspaceApiSdk::FolderContentIntegerArrayWrapper.new(
  response: null,
  count: null,
  links: null,
  status: null,
