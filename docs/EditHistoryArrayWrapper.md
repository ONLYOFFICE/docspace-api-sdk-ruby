# DocspaceApiSdk::EditHistoryArrayWrapper

## Properties

| Name | Type | Description | Notes |
| ---- | ---- | ----------- | ----- |
| **response** | [**Array&lt;EditHistoryDto&gt;**](EditHistoryDto.md) | The list of EditHistoryDto objects returned by the operation. | [optional] |
...
instance = DocspaceApiSdk::EditHistoryArrayWrapper.new(
  response: null,
  count: null,
  links: null,
  status: null,
