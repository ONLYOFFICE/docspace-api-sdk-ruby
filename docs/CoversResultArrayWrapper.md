# DocspaceApiSdk::CoversResultArrayWrapper

## Properties

| Name | Type | Description | Notes |
| ---- | ---- | ----------- | ----- |
| **response** | [**Array&lt;CoversResultDto&gt;**](CoversResultDto.md) | The list of CoversResultDto objects returned by the operation. | [optional] |
...
instance = DocspaceApiSdk::CoversResultArrayWrapper.new(
  response: null,
  count: null,
  links: null,
  status: null,
