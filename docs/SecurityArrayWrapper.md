# DocspaceApiSdk::SecurityArrayWrapper

## Properties

| Name | Type | Description | Notes |
| ---- | ---- | ----------- | ----- |
| **response** | [**Array&lt;SecurityDto&gt;**](SecurityDto.md) | The list of SecurityDto objects returned by the operation. | [optional] |
...
instance = DocspaceApiSdk::SecurityArrayWrapper.new(
  response: null,
  count: null,
  links: null,
  status: null,
