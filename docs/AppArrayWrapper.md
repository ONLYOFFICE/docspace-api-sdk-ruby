# DocspaceApiSdk::AppArrayWrapper

## Properties

| Name | Type | Description | Notes |
| ---- | ---- | ----------- | ----- |
| **response** | [**Array&lt;AppDto&gt;**](AppDto.md) | The list of AppDto objects returned by the operation. | [optional] |
...
instance = DocspaceApiSdk::AppArrayWrapper.new(
  response: null,
  count: null,
  links: null,
  status: null,
