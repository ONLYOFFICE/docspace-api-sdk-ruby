# DocspaceApiSdk::WalletServiceArrayWrapper

## Properties

| Name | Type | Description | Notes |
| ---- | ---- | ----------- | ----- |
| **response** | [**Array&lt;WalletServiceDto&gt;**](WalletServiceDto.md) | The list of WalletServiceDto objects returned by the operation. | [optional] |
...
instance = DocspaceApiSdk::WalletServiceArrayWrapper.new(
  response: null,
  count: null,
  links: null,
  status: null,
