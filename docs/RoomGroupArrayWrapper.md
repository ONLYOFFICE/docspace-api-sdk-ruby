# DocspaceApiSdk::RoomGroupArrayWrapper

## Properties

| Name | Type | Description | Notes |
| ---- | ---- | ----------- | ----- |
| **response** | [**Array&lt;RoomGroupDto&gt;**](RoomGroupDto.md) | The list of RoomGroupDto objects returned by the operation. | [optional] |
...
instance = DocspaceApiSdk::RoomGroupArrayWrapper.new(
  response: null,
  count: null,
  links: null,
  status: null,
