# DocspaceApiSdk::EmployeeArrayWrapper

## Properties

| Name | Type | Description | Notes |
| ---- | ---- | ----------- | ----- |
| **response** | [**Array&lt;EmployeeDto&gt;**](EmployeeDto.md) | The list of EmployeeDto objects returned by the operation. | [optional] |
...
instance = DocspaceApiSdk::EmployeeArrayWrapper.new(
  response: null,
  count: null,
  links: null,
  status: null,
