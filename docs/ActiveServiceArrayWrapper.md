# DocspaceApiSdk::ActiveServiceArrayWrapper

## Properties

| Name | Type | Description | Notes |
| ---- | ---- | ----------- | ----- |
| **response** | [**Array&lt;ActiveServiceDto&gt;**](ActiveServiceDto.md) | The list of ActiveServiceDto objects returned by the operation. | [optional] |
...
instance = DocspaceApiSdk::ActiveServiceArrayWrapper.new(
  response: null,
  count: null,
  links: null,
  status: null,
