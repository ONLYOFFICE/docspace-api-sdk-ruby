...
module DocspaceApiSdk
  ...
  class TenantQuota < ApiModelBase
    ...
    def hash
      [tenant_id, name, price, price_currency_symbol, price_iso_currency_symbol, product_id, service_name, service_group, visible, wallet, due_date, features, max_file_size, max_total_size, count_user, count_room_admin, users_in_room, count_room, non_profit, trial, free, update, audit, docs_edition, ldap, sso, statistic, branding, customization, lifetime, automation_api, custom, restore, oauth, content_search, third_party, year, count_free_backup, backup, count_ai_agent, ai_tools].hash
    end
