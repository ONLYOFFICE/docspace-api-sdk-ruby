  ...
  class Tariff < ApiModelBase
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DocspaceApiSdk::Tariff` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `DocspaceApiSdk::Tariff`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'overdue_quotas')
        if (value = attributes[:'overdue_quotas']).is_a?(Array)
          self.overdue_quotas = value
        end
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          quotas == o.quotas &&
          overdue_quotas == o.overdue_quotas
    end
    ...
    def hash
      [id, state, due_date, delay_due_date, license_date, customer_id, quotas, overdue_quotas].hash
    end
