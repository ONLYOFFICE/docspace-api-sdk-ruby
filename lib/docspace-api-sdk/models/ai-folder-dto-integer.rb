...
module DocspaceApiSdk
  ...
  class AiFolderDtoInteger < ApiModelBase
    ...
    def self.openapi_types
      {
        ...
        :'expired' => :'Boolean',
        :'chat_settings' => :'AiChatSettingsDto',
        :'root_room_type' => :'AiRoomType',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DocspaceApiSdk::AiFolderDtoInteger` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `DocspaceApiSdk::AiFolderDtoInteger`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'folders_count')
        self.folders_count = attributes[:'folders_count']
      end
      ...
      if attributes.key?(:'in_room')
        self.in_room = attributes[:'in_room']
      end
      ...
      if attributes.key?(:'root_room_type')
        self.root_room_type = attributes[:'root_room_type']
      end
