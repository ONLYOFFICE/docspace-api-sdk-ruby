  ...
  class AiThread < ApiModelBase
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DocspaceApiSdk::AiThread` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `DocspaceApiSdk::AiThread`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'last_edit_date')
        self.last_edit_date = attributes[:'last_edit_date']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          title == o.title &&
          last_edit_date == o.last_edit_date &&
          provider == o.provider &&
          model == o.model &&
    ...
    def hash
      [thread_id, title, last_edit_date, provider, model, profile_id].hash
    end
