...
module DocspaceApiSdk
  ...
  class WebPluginDto < ApiModelBase
    ...
    def hash
      [name, version, min_doc_space_version, description, license, author, home_page, plugin_name, scopes, image, create_by, create_on, enabled, system, url, css_url, settings, name_locale, description_locale].hash
    end
