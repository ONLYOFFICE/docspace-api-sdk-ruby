...
module DocspaceApiSdk
  ...
  class CreateAgentRequestDto < ApiModelBase
    # The room name.
    attr_accessor :title
    ...
    attr_accessor :attach_default_tools
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DocspaceApiSdk::CreateAgentRequestDto` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `DocspaceApiSdk::CreateAgentRequestDto`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'chat_settings')
        ...
        self.chat_settings = nil
      end

      if attributes.key?(:'attach_default_tools')
        self.attach_default_tools = attributes[:'attach_default_tools']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @chat_settings.nil?
        invalid_properties.push('invalid value for "chat_settings", chat_settings cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @chat_settings.nil?
      true
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] chat_settings Value to be assigned
    def chat_settings=(chat_settings)
      if chat_settings.nil?
        fail ArgumentError, 'chat_settings cannot be nil'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          attach_default_tools == o.attach_default_tools
    end
    ...
    def hash
      [title, quota, indexing, deny_download, lifetime, watermark, logo, tags, color, cover, private, share, chat_settings, attach_default_tools].hash
    end
