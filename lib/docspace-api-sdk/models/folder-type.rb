...
module DocspaceApiSdk
  class FolderType
    ...
    def build_from_hash(value)
      return value if FolderType.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #FolderType"
    end
  end
end
