...
module DocspaceApiSdk
  module Files
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [Time] :from_date The start date of the history.
    # @option opts [Time] :to_date The end date of the history.
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [Array<AccessRequestKeyDto>] :access_request_key_dto Collection of encryption key data for users with access to the file
    # @return [nil]
