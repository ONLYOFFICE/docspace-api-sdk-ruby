...
module DocspaceApiSdk
  module Files
    ...
    # @param folder_id [Integer] The folder ID whose history is exported.
    # @param [Hash] opts the optional parameters
    # @option opts [AuditReportFormat] :format The output file format of the report. Defaults to XLSX.
    # @option opts [Time] :from The start date of the history period to export.
    # @option opts [Time] :to The end date of the history period to export.
    ...
    # @option opts [Array<Integer>] :folder_type The parent folder types used to filter the folder contents by folder type.
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [Time] :from_date The start date of the history request.
    # @option opts [Time] :to_date The end date of the history request.
