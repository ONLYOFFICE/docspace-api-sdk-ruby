...
module DocspaceApiSdk
  module Files
    ...
    # @param [Hash] opts the optional parameters
    # @return [FileShareArrayWrapper]
    def set_file_security_info(file_id, security_info_simple_request_dto, opts = {})
      data, _status_code, _headers = set_file_security_info_with_http_info(file_id, security_info_simple_request_dto, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(FileShareArrayWrapper, Integer, Hash)>] FileShareArrayWrapper data, response status code and response headers
    def set_file_security_info_with_http_info(file_id, security_info_simple_request_dto, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: Files::SharingApi.set_file_security_info ...'
      end
      # verify the required parameter 'file_id' is set
      if @api_client.config.client_side_validation && file_id.nil?
        fail ArgumentError, "Missing the required parameter 'file_id' when calling Files::SharingApi.set_file_security_info"
      end
      ...
      # resource path
      local_var_path = '/api/2.0/files/file/{fileId}/share'.sub('{' + 'fileId' + '}', CGI.escape(file_id.to_s))
    ...
    # @param [Hash] opts the optional parameters
    # @return [FileShareArrayWrapper]
    def set_folder_security_info(folder_id, security_info_simple_request_dto, opts = {})
      data, _status_code, _headers = set_folder_security_info_with_http_info(folder_id, security_info_simple_request_dto, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(FileShareArrayWrapper, Integer, Hash)>] FileShareArrayWrapper data, response status code and response headers
    def set_folder_security_info_with_http_info(folder_id, security_info_simple_request_dto, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: Files::SharingApi.set_folder_security_info ...'
      end
      # verify the required parameter 'folder_id' is set
      if @api_client.config.client_side_validation && folder_id.nil?
        fail ArgumentError, "Missing the required parameter 'folder_id' when calling Files::SharingApi.set_folder_security_info"
      end
      # verify the required parameter 'security_info_simple_request_dto' is set
      if @api_client.config.client_side_validation && security_info_simple_request_dto.nil?
      ...
      # resource path
      local_var_path = '/api/2.0/files/folder/{folderId}/share'.sub('{' + 'folderId' + '}', CGI.escape(folder_id.to_s))
