...
module DocspaceApiSdk
  module Files
    ...
    # @option opts [Array<Integer>] :folder_type The parent folder types used to empty the trash only from the items originally located in the sections of the specified types.
    # @return [FileOperationArrayWrapper]
