...
module DocspaceApiSdk
  module Settings
    ...
    def get_tenant_banner_settings(opts = {})
      data, _status_code, _headers = get_tenant_banner_settings_with_http_info(opts)
      data
    end
    ...
    def get_tenant_banner_settings_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: Settings::BannersVisibilityApi.get_tenant_banner_settings ...'
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"Settings::BannersVisibilityApi.get_tenant_banner_settings",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: Settings::BannersVisibilityApi#get_tenant_banner_settings\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
