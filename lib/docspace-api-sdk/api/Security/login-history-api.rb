...
module DocspaceApiSdk
  module Security
    ...
    # @option opts [ApiDateTime] :from The starting date and time for filtering login events.
    # @option opts [ApiDateTime] :to The ending date and time for filtering login events.
